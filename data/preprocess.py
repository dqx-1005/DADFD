...
def create_subgraph(dataset,sparse_graph,_sentinel=None,nodes_to_remove=None,nodes_to_keep=None):
    ...
    if dataset in ['coauthor-cs','coauthor-phy','amazon-photo','pubmed']:
        ...
        #sparse_graph = sparse_graph[nodes_to_keep][:, nodes_to_keep]
...
def largest_connected_components(dataset, sparse_graph, n_components=1):
    ...
    return create_subgraph(dataset,sparse_graph,nodes_to_keep=nodes_to_keep)
